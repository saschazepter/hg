...
CHANGE_ADDED = merge_utils.CHANGE_ADDED
CHANGE_REMOVED = merge_utils.CHANGE_REMOVED
CHANGE_MODIFIED = merge_utils.CHANGE_MODIFIED

ACTION_FORGET = merge_utils.ACTION_FORGET
ACTION_REMOVE = merge_utils.ACTION_REMOVE
ACTION_ADD = merge_utils.ACTION_ADD
ACTION_GET = merge_utils.ACTION_GET
ACTION_PATH_CONFLICT = merge_utils.ACTION_PATH_CONFLICT
ACTION_PATH_CONFLICT_RESOLVE = merge_utils.ACTION_PATH_CONFLICT_RESOLVE
ACTION_ADD_MODIFIED = merge_utils.ACTION_ADD_MODIFIED
ACTION_CREATED = merge_utils.ACTION_CREATED
ACTION_DELETED_CHANGED = merge_utils.ACTION_DELETED_CHANGED
ACTION_CHANGED_DELETED = merge_utils.ACTION_CHANGED_DELETED
ACTION_MERGE = merge_utils.ACTION_MERGE
ACTION_LOCAL_DIR_RENAME_GET = merge_utils.ACTION_LOCAL_DIR_RENAME_GET
ACTION_DIR_RENAME_MOVE_LOCAL = merge_utils.ACTION_DIR_RENAME_MOVE_LOCAL
ACTION_KEEP = merge_utils.ACTION_KEEP
ACTION_KEEP_ABSENT = merge_utils.ACTION_KEEP_ABSENT
ACTION_KEEP_NEW = merge_utils.ACTION_KEEP_NEW
ACTION_EXEC = merge_utils.ACTION_EXEC
ACTION_CREATED_MERGE = merge_utils.ACTION_CREATED_MERGE
