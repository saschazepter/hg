...
One with >200 heads. We now switch to send them all in the initial roundtrip, but still do sampling for the later request.
  ...
  comparing with b
  query 1; heads + initial-local-heads (sample size is 260)
  searching for changes
  taking quick initial sample
  searching: 2 queries
...
remote will be last 25 heads of the local graph
  ...
  > --config devel.discovery.randomize=false
  comparing with b
  query 1; heads + initial-local-heads (sample size is 25)
  searching for changes
  taking quick initial sample
  ...
  [
   {
    ...
    "nb-revs-common": 300,
    "nb-revs-missing": 100,
    "output": "query 1; heads + initial-local-heads (sample size is 25)\nsearching for changes\ntaking quick initial sample\nquery 2; still undecided: 375, sample size is: 81\nsampling from both directions\nquery 3; still undecided: 3, sample size is: 3\n3 total queries in *\n", (glob)
    "total-queries": 109,
    "total-roundtrips": 3
   }
  ]
