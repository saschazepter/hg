#require no-chg
  ...
  Traceback (most recent call last):
    File "*/mercurial/main_script/__init__.py", line *, in _runexithandlers (glob) (no-pyoxidizer !)
    File "mercurial/main_script/__init__.py", line *, in _runexithandlers (glob) (pyoxidizer !)
      func(*args, **kwargs)
      ~~~~^^^^^^^^^^^^^^^^^ (py313 !)
