...
The extension requires a repo (currently unused)
  ...
  stream2 -- {bytecount: 1913, filecount: 14, requirements: generaldelta%2Crevlog-compression-zstd%2Crevlogv1%2Csparserevlog} (mandatory: True) (stream-v2 zstd no-rust !)
...
==========================================================
  ...
  adding [s] 00manifest.i (654 bytes) (zstd !)
  ...
  bundle2-input-part: total payload size 2104 (no-rust zstd !)
...
(also test unlimited memory usage code path)
  ...
  bundle2-input-part: total payload size 2118 (no-rust zstd !)
  stream-cloned 16 files / 2.05 KB in * seconds (* */sec) (glob) (rust !)
