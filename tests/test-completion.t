...
Show all commands + options
  ...
  admin::narrow-server: shape-fingerprints, shape-patterns, shape-narrow-patterns, shape-files, shape-files-hidden, shape-update, file, override-reshape-and-reshard-check, template
