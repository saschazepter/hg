...
#if zlib-ng
  $ f -s */.hg/store/data/*.d
  incremental-10-pull/.hg/store/data/_s_p_a_r_s_e-_r_e_v_l_o_g-_t_e_s_t-_f_i_l_e.d: size=23671272
  sparse-repo/.hg/store/data/_s_p_a_r_s_e-_r_e_v_l_o_g-_t_e_s_t-_f_i_l_e.d: size=23671272
#else
  $ f -s */.hg/store/data/*.d
...
#if zlib-ng
  $ f -s */.hg/store/data/*.d
  incremental-10-pull/.hg/store/data/_s_p_a_r_s_e-_r_e_v_l_o_g-_t_e_s_t-_f_i_l_e.d: size=27288785
  sparse-repo/.hg/store/data/_s_p_a_r_s_e-_r_e_v_l_o_g-_t_e_s_t-_f_i_l_e.d: size=27288785
#else
  $ f -s */.hg/store/data/*.d
